 ...
 */
package com.letu.healthplatform.platformmanage.excel.util;
...
import com.letu.healthplatform.platformmanage.excel.annotation.ExcelEntity;
import com.letu.healthplatform.platformmanage.excel.annotation.ExcelIgnore;
import com.letu.healthplatform.platformmanage.excel.entity.vo.PoiBaseConstants;
import com.letu.healthplatform.platformmanage.excel.world.entity.WordImageEntity;
import com.letu.healthplatform.platformmanage.excel.world.entity.params.ExcelListEntity;
...
public final class PoiPublicUtil {
    ...
    private static final Logger LOGGER = LogManager.getLogger(PoiPublicUtil.class);
    ...
    public static Method getMethod(String name, Class<?> pojoClass) throws Exception {
        ...
        //TODO 根据自己的实体情况处理
        if(!"T".equals(name.substring(0, 1).toUpperCase())) {
        ...
        Method method = null;
        try {
        	//LOGGER.info("getMethodName{},"+getMethodName.toString());
