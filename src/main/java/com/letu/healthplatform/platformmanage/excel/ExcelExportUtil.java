...
import com.letu.healthplatform.platformmanage.excel.export.ExcelExportServer;
import com.letu.healthplatform.platformmanage.excel.export.template.ExcelExportOfTemplateUtil;
...
public final class ExcelExportUtil {
	...
	final static Logger logger =LogManager.getLogger(ExcelExportUtil.class);
    ...
    public static Workbook exportExcel(ExportParams entity, Class<?> pojoClass,
                                       Collection<?> dataSet) {
        Workbook workbook;
        logger.info("excelType is check,{}"+entity.getType());
